        ...
        <div class="row justify-content-center">
            <div class="card col-md-8">
                <div class="card-header">
                    <h4 class="card-title">@lang('admin.roles.create')</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.roles.store') }}" aria-label="@lang('admin.roles.create')">
                        @csrf
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">@lang('general.name')</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') ? old('name') : '' }}" required autofocus>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="label" type="label" class="form-control{{ $errors->has('label') ? ' is-invalid' : '' }}" name="label" value="{{ old('label') ? old('label') : '' }}" required>
                                @if ($errors->has('label'))
                                    <span class="invalid-feedback" role="alert">
